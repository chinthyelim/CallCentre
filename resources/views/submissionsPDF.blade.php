...
@section('content')
<div id="stickyHeader">
  <p>Below is the answered questionnaire for <b>ticket number: <u>{{ $ticket_number }}</u></b></p>
  <div class="top">
    <div class="topLeft">
    ...
    <div class="topRight">
      <button class="button copyClipboard" onclick="copyToClipboard()"><i class="material-icons">file_copy</i></button>
    </div>
  </div>
</div>
<div class="container">
